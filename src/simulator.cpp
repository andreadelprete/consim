...
//                      pinocchio::Data &data, bool use_exp_integrator, bool sparse_solver, 
//                      bool invertibleA) : dt_(dt), n_integration_steps_(n_integration_steps),
//                                                                                                              model_(&model), data_(&data), useExponentialIntegrator_(use_exp_integrator),
